...
def sfsDeploy():
    ...
    try:
        ...
        # Step 5: Create SFS release directory and extract each inner tar into it
    ...
    # then rename to versioned dir and create symlink
    # e.g. tfg/ -> tfg-0.1.0/  and  tfg -> tfg-0.1.0
    components = getComponents()
    for comp in components:
        ...
        # Verify extracted component directory exists
