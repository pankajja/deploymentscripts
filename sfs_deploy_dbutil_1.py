...
def init():
    ...
    conditional.add_argument('--envFolder', nargs='?', help='Path to directory containing envInfo.json',
    ...
    optional.add_argument('--dbutilRoot', nargs='?',
                          help='DB Utils deployment root directory (default: /cls/dbutils)',
